...
//  LoginApp
//
//  Created by JLM Consulting on 27/05/2017.
...
class LoginViewController: UIViewController {
    ...
    let loginButon: UIButton = {
        ...
        button.backgroundColor = .rgbColor(red: 75, green: 90, blue: 171, alpha: 1)
    ...
    lazy var profileImageView : UIImageView = {
        ...
        image.image = UIImage(named: "HMLoginApp")
    ...
    var registrationFormItems: [String] = ["First Name","Last Name", "Email adress", "Password"]
    var textFields = [UITextField]()
    
    lazy var nameTextField: UITextField? = { self.getRegistrationFormItem(itemName: self.registrationFormItems[0]) }()
    lazy var lastTextField: UITextField? = { self.getRegistrationFormItem(itemName: self.registrationFormItems[1]) }()
    lazy var emailTextField: UITextField? =  { self.getRegistrationFormItem(itemName: self.registrationFormItems[2])}()
    lazy var passwordTextField: UITextField? = { self.getRegistrationFormItem(itemName: self.registrationFormItems[3])}()
    ...
    private func setupInputContainerView () {
        view.layoutIfNeeded()
        let constant = inputContainerView.frame.height / 6
    ...
    private func setupViews() {
        ...
        inputContainerViewHeightConstrate = inputContainerView.heightAnchor.constraint(equalToConstant: 200)
    ...
    override func viewDidLoad() {
        super.viewDidLoad()
        view.backgroundColor = .rgbColor(red: 21, green: 41, blue: 91, alpha: 1)
        setupViews()
    }
